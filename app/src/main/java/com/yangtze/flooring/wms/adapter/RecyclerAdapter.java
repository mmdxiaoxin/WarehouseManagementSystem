...
public class RecyclerAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            case DataBean.PARENT_ITEM:
                view = mInflater.inflate(R.layout.item_notifications_recycleview_parent, parent, false);
                return new ParentViewHolder(context, view);
            case DataBean.CHILD_ITEM:
                view = mInflater.inflate(R.layout.item_notifications_recycleview_child, parent, false);
    ...
    private DataBean getChildDataBean(DataBean bean){
        ...
        child.setType(1);
        child.setParentLeftTxtName(bean.getParentLeftTxtName());
        child.setParentRightTxtCategory(bean.getParentRightTxtCategory());
        child.setParentRightTxtQuantity(bean.getParentRightTxtQuantity());
